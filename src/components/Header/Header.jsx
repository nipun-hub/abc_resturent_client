      ...
      <div className="w-full h-1/2  relative overflow-hidden rounded-lg">
        {images.map((image, index) => (
          <img
            ...
            src={image}
            alt="Carousel Image"
            className={`h-full w-full object-cover absolute top-0 left-0 transition-opacity duration-1000 ease-in-out transform ${currentIndex === index ? 'translate-x-0' : 'translate-x-full'
              }`}
          />
        ))}
      </div>
