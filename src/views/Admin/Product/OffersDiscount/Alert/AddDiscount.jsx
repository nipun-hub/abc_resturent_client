            ...
            <Dialog size="sm" open={open} handler={close} className="p-4">
                ...
                <div className=" w-full p-10 bg-white rounded-xl z-10 flex flex-col gap-1 max-h-[90vh] overflow-auto">
                    ...
                    <div className="grid grid-cols-1 space-y-2 w-full">
                        ...
                        <Input type='number' value={addItemData.discountPercentage} name='discountPercentage' label='Discount percentage' color='blue-gray' className='before::outline-gray-300 text-s' onChange={(e) => updateSetAddItemData(e.target.name, e.target.value)} />
                    </div>
                    <div>
