...
const SideBar = () => {
    ...
    return (
        <div className="SideBar">
            ...
            >
                <div className="grid w-full items-center gap-2.5 font-medium border-b py-3 border-slate-300  mx-3 ">
                    <img
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRk5SQtIuKlk7JkrDr3PucubpwFUuNa57yMEw&s"
                        width={45}
                        alt=""
